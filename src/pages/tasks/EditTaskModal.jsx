...
export default function EditTaskModal({ task, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#00000070] bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 my-8 max-h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-grow">
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mt-6 flex justify-end space-x-3 sticky bottom-0 bg-white pt-4 pb-2">
              <button
                type="button"
                onClick={onClose}
